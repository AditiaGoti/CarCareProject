		...
		<div class="wrapper">
			...
			<div class="inner">
				<form action="" method="post">
					...
					<div class="form-holder">
						<span class="lnr lnr-envelope" style="color: white;">{{ $title }}</span>
						<input type="text" class="form-control" placeholder="Tittle">
					</div>
					<div class="form-holder">
						<span class="lnr lnr-lock"style="color: white;">{{ $merek}}</span>
						<input type="text" class="form-control" placeholder="Merek">
					</div>
					<div class="form-holder">
						<span class="lnr lnr-lock"style="color: white;">{{ $price}}</span>
